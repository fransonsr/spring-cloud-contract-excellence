...
/**
 * Intended for use with JUnit's {@link ExpectedException}. Provides the opportunity
 * to validate mocks when the test method throws an exception. Example:
 * <pre>
...
public abstract class VerificationMethod extends BaseMatcher<Throwable> {
    ...
    @SuppressWarnings("squid:S00112") // this is used for testing with unknown exceptions
